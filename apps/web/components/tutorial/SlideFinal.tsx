  ...
  return (
    ...
    >
      <div className="tutorial-final-picker" role="group" aria-label="Избор на семейство">
        <Link href="/werewolf/create" prefetch={false} className="tutorial-final-card" data-family="werewolves">
        ...
        <Link href="/mafia/create" prefetch={false} className="tutorial-final-card" data-family="mafia">
      ...
      <div className="tutorial-final-secondary-grid">
        <Link href="/werewolf/rules" prefetch={false} className="tutorial-final-secondary-card">
        ...
        <Link href="/mafia/rules" prefetch={false} className="tutorial-final-secondary-card">
        ...
        <Link href="/roles" prefetch={false} className="tutorial-final-secondary-card">
