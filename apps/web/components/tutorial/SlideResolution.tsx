    ...
    <TutorialSlide
      ...
      body={
        <>
          ...
          <p>
            И след всичко това остава записът. Архивът помни ходовете. Класацията помни имената. Легендите
            помнят моментите.
          </p>
        </>
      }
      callout={{
        label: "След вечерта",
        text: "Виж записа, провери класацията, отключи легенди. Това е следата на вашата вечер.",
      }}
    />
  );
}
