...
const WEREWOLF_PHASES: PhaseRule[] = [
  ...
  },
  {
    ...
    title: "Ден",
    short: "спор",
    body: "Всички живи играчи обсъждат кой лъже. В режим без писмен разговор или на живо приложението става табло с фаза и таймер.",
  ...
  },
  {
    ...
    example: "При равни гласове, ако Кметът е подкрепил един от кандидатите с равен резултат, неговият избор решава.",
  ...
  },
  {
    ...
    body: "Всички смърти и свързани ефекти се разрешават по ред: последен изстрел на Ловеца, наследяване на Кмета, Влюбени и победа.",
    timer: "10-20 секунди",
    wakes: "Само роли със задействан ефект, например Ловец.",
    example: "Ако Ловецът умре, играта спира за последния му изстрел.",
    watch: "Изчакай всички задействани ефекти да приключат преди следващия спор.",
  },
];
...
const MAFIA_PHASES: PhaseRule[] = [
  {
    ...
    title: "Маса",
    short: "алибита",
    body: "Стаята избира свободна или спортна Мафия, брой играчи, таймери, писмен разговор и дали Докторът може да пази себе си.",
    timer: "без таймер",
  ...
  },
  {
    ...
    title: "Присъда",
    short: "последствие",
    body: "Присъдата се изпълнява, ролята се разкрива според настройките и се проверява дали Градът или Мафията печели.",
    timer: "10-20 секунди",
...
export function GameRulesPage({ family }: { family: GameFamily }) {
  ...
  return (
    <main className="shell rules-shell" data-faction={family} data-family={family}>
      ...
      <GameRulesPhaseTimeline phases={phases} mode={mode} />

      <section className="rules-table-mode rules-table-protocol">
        <div>
          <p className="section-kicker">игра на живо без писмен разговор</p>
