...
const SECTIONS: readonly SectionData[] = [
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <ul>
          <li>
            <strong>Hetzner</strong> — хостинг на сървърите, базата данни и шифрованите резервни
            копия в избрана европейска локация.
          </li>
          <li>
  ...
  },
  {
    ...
    tldr:
      "Досие докато не го изтриеш. Сесии 30 дни. Подробни игрови събития до 24 месеца. Шифровани резервни копия до 30 дни.",
    body: (
      <ul>
        <li>
        ...
        <li>
          <strong>Игрови записи</strong> — подробните събития се пазят до 24 месеца. Обобщената
          история, статистиката и легендите остават до изтриване на досието.
        </li>
        <li>
        ...
        <li>
          <strong>Шифровани резервни копия</strong> — до 30 дни, след което се изтриват
          автоматично.
        </li>
        <li>
          <strong>Технически запис за изтриване</strong> — отделно пазим само връзката между
          стария и анонимния идентификатор, без име, имейл или игрово съдържание. Тя се използва,
          за да прилагаме изтриването отново при възстановяване, и се обновява с шестчасовия
          архивен цикъл. При пълна загуба непосредствено след изтриване последните до шест часа
          може още да не са записани във външното копие.
        </li>
      </ul>
    ),
  },
