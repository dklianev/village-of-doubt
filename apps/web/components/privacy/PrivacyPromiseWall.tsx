...
const PROMISES: readonly PrivacyPromise[] = [
  ...
  },
  {
    ...
    detail:
      "Профилът, легендите и личните данни изчезват веднага. Имената от игрите ти се заменят с „Изтрит играч“, за да не се чупи историята на другите играчи на масата.",
  },
  {
    id: "export-anytime",
    icon: "export-anytime",
    ...
    detail:
      "Един клик — получаваш JSON файл с профила, игрите, легендите и настройките. Файлът е структуриран и четим.",
  },
];
