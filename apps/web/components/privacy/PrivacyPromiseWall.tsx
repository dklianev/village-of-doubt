...
const PROMISES: readonly PrivacyPromise[] = [
  ...
  },
  {
    id: "eu-host",
    icon: "eu-host",
    title: "Сървърите ни са в Европейския съюз.",
    summary: "Основната инфраструктура и шифрованите резервни копия са в избрана локация на Hetzner в ЕС.",
    detail:
      "Базата данни, игровият сървър и шифрованите резервни копия се съхраняват в избрана локация на Hetzner в ЕС. Техническите партньори и целите на обработването са описани по-долу.",
  },
  {
    id: "delete-anytime",
    icon: "delete-anytime",
    title: "Изтриваш досието по всяко време.",
    summary: "Активните данни се заличават веднага. Шифрованите резервни копия — до 30 дни.",
    detail:
      "Досието, легендите и личните данни се заличават от активната система веднага. Имената в общата история се заменят с „Изтрит играч“. Отделен защитен регистър пази само стария и анонимния технически идентификатор, без име, имейл или игрово съдържание, за да прилагаме извършеното изтриване и при възстановяване.",
  },
  {
    id: "export-anytime",
    icon: "export-anytime",
    ...
    detail:
      "Един клик — получаваш JSON файл с досието, игрите, легендите и настройките. Файлът е структуриран и четим.",
  },
];
