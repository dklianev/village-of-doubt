...
`pnpm check:dict` разпознава границите на кирилските думи. Формите „Чат", „чата", „чатове" и „чатовете" се отчитат като нарушения на каноничното „Разговор".

## 07 · Глас и тон

Текстът е съвременен разговорен български с умерена мрачна атмосфера. Първо казва какво се случва или какво трябва да направи играчът; образността идва след това и само ако помага на сцената.

| Повърхност | Глас | Пример |
|---|---|---|
| Начална страница | Социален, уверен, без техническа архитектура | „Избери игра, събери приятелите си и започни с код." |
| Създаване на стая | Кратък и практичен | „Избери жив участник." |
| Активна игра | Стегнат и напрегнат | „Гласуването не е отворено в момента." |
| Личен нощен резултат | Второ лице, без двусмислие | „Не усети движение до себе си тази нощ." |
| Грешка | Спокойна причина и следваща стъпка | „Действаш твърде бързо. Изчакай малко." |
| Роли и правила | Точна механика, най-много едно атмосферно изречение | „Всяка нощ проверяваш един играч." |
| История и финал | Разказно, но фактически вярно | „Върколаците вече контролират гласуването." |
| Профил и вход | Човешки и директен | „Влез отново, за да продължиш." |

### Лице и обръщение

- Към един играч говорим на „ти": „избери", „можеш", „ролята ти".
- Към цялата маса говорим в множествено число: „обсъдете", „гласувайте".
- Не смесваме „Изберете" и „избери" в един и същ поток.
- Частното съобщение не повтаря ролята в трето лице. Казваме „Усети движение", не „Неспящата усети движение".

### Технически думи

„Сървър", „сесия", „токен" и „канал" са допустими, когато назовават реален технически обект в състояние, поверителност, помощ или диагностика. На началната страница и в основния игрови поток описваме преживяването, не архитектурата. Не заменяме механично точен термин, ако заместителят става неясен.

### Избягваме

- Вътрешни понятия като „команда", „фракционна жертва", `advanced` и кодове на роли в текст към играча.
- Формули от типа „Добър [роля]...", „не X, а Y" и празни метафори, които не обясняват механиката.
- Лог формат като „Име: причина". Съобщението трябва да е изречение: „Анна падна от атаката на Мафията."
- Математически финали като „равни или повече". Обясняваме резултата в езика на играта: „Мафията вече контролира гласуването."
