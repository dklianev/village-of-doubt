...
| Кмет | +2 | implemented | Тайна роля остава скрита в синхронизирания state; гласът решава само при равенство. |
...
| Ковач | +2 | implemented (digital) | Веднъж дава меч на друг играч; дигиталният flow избира получател и цел в една стъпка. |
